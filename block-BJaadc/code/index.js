...
console.log(`The last character of ${message} is ${message.charAt(0)}`);

// Log the index of word "you" in message
console.log(`the indeex of word "you" is ${message.indexOf("you")}`);

// Log the index of word "still" in message
console.log(`the indeex of word "you" is ${message.indexOf("still")}`);
// Log the index of word "answers" in message
console.log(`the indeex of word "you" is ${message.indexOf("answers")}`);
